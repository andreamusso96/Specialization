...
from DataPreprocessing.Step2.SpecializationIndex import SpecializationIndex
...
def run_pipeline():
    ...
    employment_by_occ_distance = EmploymentByOccDistance(occ_network=onet_network_data, omsa_data=omsa_data, quantiles=quantiles)
    ...
    specialization_index = SpecializationIndex(occ_network=onet_network_data, omsa_data=omsa_data)
